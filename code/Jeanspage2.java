...
public class Jeanspage2 {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 1451, 842);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(getDetails.geticon("https://raw.githubusercontent.com/Umesh9966/Images/main/jeans6.png")));
		lblNewLabel_2.setBounds(996, 10, 202, 351);
		...
		JLabel lblNewLabel_2_1 = new JLabel("Men Navy Jeans");
		lblNewLabel_2_1.setIcon(new ImageIcon(getDetails.geticon("https://raw.githubusercontent.com/Umesh9966/Images/main/jeans%205.png")));
		lblNewLabel_2_1.setBounds(541, 10, 257, 356);
		frame.getContentPane().add(lblNewLabel_2_1);
		
		JLabel lblNewLabel_2_1_1 = new JLabel("");
		lblNewLabel_2_1_1.setIcon(new ImageIcon(getDetails.geticon("https://raw.githubusercontent.com/Umesh9966/Images/main/jeans%204.png")));
		lblNewLabel_2_1_1.setBounds(37, 10, 323, 351);
		...
		JLabel lblMenBlueJeans = new JLabel("Men Blue Jeans");
		lblMenBlueJeans.setHorizontalAlignment(SwingConstants.CENTER);
		lblMenBlueJeans.setFont(new Font("Arial", Font.PLAIN, 20));
		lblMenBlueJeans.setBounds(10, 387, 398, 41);
		frame.getContentPane().add(lblMenBlueJeans);
		
		JLabel lblMenNavyJeans = new JLabel("Men Navy Jeans");
		lblMenNavyJeans.setHorizontalAlignment(SwingConstants.CENTER);
		lblMenNavyJeans.setFont(new Font("Arial", Font.PLAIN, 20));
		lblMenNavyJeans.setBounds(481, 387, 398, 41);
		frame.getContentPane().add(lblMenNavyJeans);
		
		JLabel lblMenBlackJeans = new JLabel("Men Black Jeans");
		lblMenBlackJeans.setHorizontalAlignment(SwingConstants.CENTER);
		lblMenBlackJeans.setFont(new Font("Arial", Font.PLAIN, 20));
		lblMenBlackJeans.setBounds(968, 387, 398, 41);
		frame.getContentPane().add(lblMenBlackJeans);
		
		JSeparator separator_2 = new JSeparator();
		separator_2.setBounds(10, 706, 1346, 2);
		frame.getContentPane().add(separator_2);
		
		JLabel lblNewLabel_1 = new JLabel("Color  : Blue");
		...
		JLabel lblNewLabel_1_2 = new JLabel("Color  : Black");
		...
		JLabel lblNewLabel_1_4_1 = new JLabel("Price  :  \u20B9  2500");
		...
		JLabel lblNewLabel_1_4_2 = new JLabel("Price  :  \u20B9 1999");
